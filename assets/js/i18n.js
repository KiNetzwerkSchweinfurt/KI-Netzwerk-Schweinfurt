...
window.I18N = {
  de: {
    ...
    home: {
      ...
      heroPanelTitle: "Brücken bauen für KI in der Region",
      heroPanelText:
        "Wir fördern den Dialog zwischen Unternehmen, Hochschulen und Verwaltungen. Unser Fokus liegt auf konkreten Praxisbeispielen, seriöser Umsetzung und langfristigem Wissensaustausch.",
      ...
      feature1Text: "Wir bringen Unternehmen, Forschung und öffentliche Einrichtungen aus Schweinfurt zusammen und schaffen einen neutralen Austauschraum.",
      feature2Title: "Praxis fördern",
      feature2Text: "Unsere Formate setzen auf realistische KI-Anwendungen, die im Mittelstand und in der Verwaltung Mehrwert liefern.",
      feature3Title: "Kompetenz stärken",
      feature3Text: "Workshops, Impulse und Lernangebote helfen der Region, KI sicher und verantwortungsvoll zu nutzen.",
      feature4Title: "Vertrauen schaffen",
      feature4Text: "Offene Diskussionen, Datenschutz und Transparenz stehen im Zentrum unserer Netzwerkarbeit.",
  ...
  en: {
    ...
    home: {
      ...
      heroPanelTitle: "Creating strong AI connections locally",
      heroPanelText:
        "We support dialogue between businesses, universities and public institutions. Our focus is on tangible applications, responsible implementation and lasting knowledge exchange.",
      ...
      faqLabel: "FAQ",
      feature1Title: "Local connection",
      feature1Text: "We connect companies, research and public services in Schweinfurt to create a shared acting space.",
      feature2Title: "Practical focus",
      feature2Text: "Our formats are centered on realistic AI applications that support SMEs and administration.",
      feature3Title: "Strengthening skills",
      feature3Text: "Workshops and impulses help the region use AI safely and responsibly.",
      feature4Title: "Building trust",
      feature4Text: "Open discussion, data protection and transparency are key elements of our network.",
